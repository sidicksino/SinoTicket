...
const checkoutReservation = async (req, res) => {
    ...
    try {
        ...
        // 6. Trigger In-App Notification
        const notification = new Notification({
            user_id: req.auth.userId,  // The schema expects the Clerk ID string here
            title: 'Booking Confirmed!',
            message: `Your ticket for "${event?.title || 'the event'}" is ready. Tap to open your Digital Wallet.`,
            type: 'BOOKING',
