            ...
            <View className="flex-1 px-8 justify-between pb-10 pt-4">
                ...
                <View className="w-full mt-8">
                    <Animated.View entering={FadeInDown.duration(800).delay(200).springify().damping(14)}>
                        <Text className="text-[36px] font-syne font-extrabold text-[#0F172A] mb-3 text-center leading-[42px]">
                            Let&apos;s get{"\n"}started
                        </Text>
                        <Text className="text-[16px] text-center font-medium text-[#64748B] px-4 leading-6">
