  ...
  if (!isAdmin) {
    return (
      <div className="min-h-screen w-full flex bg-background items-center justify-center p-8">
        <div className="bg-card p-8 rounded-[32px] border border-error/20 shadow-2xl shadow-error/10 text-center max-w-sm w-full">
          {/* Icon */}
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <p className="text-subtext text-xs">Redirecting to login...</p>
          </div>
          <button
            onClick={() => signOut()}
